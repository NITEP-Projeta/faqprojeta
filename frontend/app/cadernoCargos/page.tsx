...
const cadernoCargosData: CargoDocument[] = [
  {
    title:
      "Mapa de Cargos e Responsabilidades",
    description:
      "Apresenta os cargos, funções, responsabilidades e níveis hierárquicos da organização, proporcionando clareza na definição dos papéis e atribuições.",
    slug:
      "mapa_cargos_responsabilidades",
    type: "Mapa de Cargos",
    icon: <FiMap size={22} />,
  },
];
...
export default function CadernoCargosPage() {
  ...
  const selectedPdfUrl =
    selectedDocument
      ? encodeURI(
          `/pdfs/cargos/${selectedDocument.slug}.pdf`
        )
      : "";
  ...
  function handleTouchEnd(
    ...
    /*
     * Em zoom manual o gesto horizontal
     * é utilizado para navegar pelo próprio PDF.
     */
    if (
      fitMode === "custom"
    ) {
    ...
    /*
     * Só considera swipe quando o
     * movimento é predominantemente horizontal.
     */
    if (
      ...
      <div className="min-h-screen bg-[#F5F5F5]">
        <div className="mx-auto w-full max-w-[1450px] px-3 py-4 sm:px-5 sm:py-5 lg:px-7">
          ...
          >
            ...
            <div className="pointer-events-none absolute -right-16 -top-20 h-64 w-64 rounded-full bg-[#AF1B1B]/[0.04] blur-3xl" />
              ...
              <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                ...
                <div className="max-w-3xl">
                  <div className="mb-2 flex items-center gap-2">
                    <FiBriefcase className="text-[#AF1B1B]" />
                  ...
                  <p className="mt-2 max-w-3xl text-[13px] leading-5 text-gray-500 sm:text-sm sm:leading-6">
                    Consulte a estrutura de cargos, responsabilidades e
                    atribuições da Projeta para compreender com clareza os
          ...
          >
            <div>
              ...
              <p className="mt-1 max-w-2xl text-xs leading-5 text-gray-500">
                Consulte o mapa corporativo para identificar cargos,
                responsabilidades e relações funcionais dentro da organização.
              </p>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 max-w-3xl text-[11px] leading-5 text-gray-500 sm:text-[12px]">
                  O mapa de cargos auxilia colaboradores e gestores na
                  compreensão das atribuições, responsabilidades e relações
                  existentes entre as diferentes funções da empresa.
                </p>
              </div>
            </div>
          </motion.section>
        ...
        <AnimatePresence>
          {selectedDocument && (
            <motion.div
              ...
              role="dialog"
              aria-modal="true"
              aria-labelledby="cargo-document-title"
            >
              <motion.div
                initial={{
                  opacity: 0,
                      ...
                      error={
                        <div className="mx-3 rounded-2xl bg-white p-7 text-center shadow-sm">
                          ...
                          <p className="mt-1 text-xs text-gray-500">
                            Não foi possível carregar o mapa de cargos.
                          </p>
