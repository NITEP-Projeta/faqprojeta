      ...
      <div className="w-full max-w-7xl">
        ...
        >
          ...
          <p className="text-[#555] mt-3">
            Documentos e orientações relacionados ao controle de ponto dos colaboradores.
          </p>
        </motion.div>
      </div>
            ...
            >
              ...
              <CardContent className="flex justify-center mt-2">
                <Button
                  ...
                  className="px-5 py-2 bg-[#AF1B1B] text-white rounded-md transition-all cursor-pointer hover:bg-[#8C1616] transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg"
                >
                  Acessar
                </Button>
              </CardContent>
